...
const App = () => {
  ...
  const onScroll= () => {
    ...
    if (
      scrollY >= 0 && scrollY < contactElement.offsetTop
    ) {
      setCurrent("Introduction");
    } else if (
      scrollY >= introductionElement.offsetTop && scrollY < skillElement.offsetTop
    ) {
      setCurrent("Contact");
    } else if (
      scrollY >= contactElement.offsetTop && scrollY < projectsElement.offsetTop
    ) {
      setCurrent("Skill");
    } else if (
      scrollY >= skillElement.offsetTop && scrollY < experienceElement.offsetTop
    ) {
      setCurrent("Projects");
    } else if (
      scrollY >= projectsElement.offsetTop && scrollY < myLifeElement.offsetTop
    ) {
    ...
    <BackgroundDiv>
      ...
      <LeftSide>
        <NavigateBar>
          ...
          <NavigateContent
            $check={current === "Contact" ? true : false}
          >
            Contact
          </NavigateContent>
          </Link>
          ...
          <NavigateContent
            $check={current === "Skill" ? true : false}
          >
            Skill
          </NavigateContent>
          </Link>
          ...
          <NavigateContent
            $check={current === "Projects" ? true : false}
          >
            Projects
          </NavigateContent>
          </Link>
          ...
          <NavigateContent
            $check={current === "Experience" ? true : false}
          >
            Experience
          </NavigateContent>
          </Link>
          ...
          <NavigateContent
            $check={current === "MyLife" ? true : false}
          >
            My Life
          </NavigateContent>
          </Link>
      ...
      <RightSide>
        ...
        <ProfileBox>
          ...
          <ProfileInstruction>
            ...
            <br />
            <br />
            자동화 툴을 만들어가는 과정에서 사람들이 원하는 제품과 서비스를 만드는 일에 크게 매료되었습니다.
            그 열정으로 프론트엔드 공부를 시작했습니다.
            <br />
            <br />
            동료 개발자들과 협업하고, 기업에서의 실제 업무 경험을 쌓고 싶었기에
2023년 8월 ~ 2023년 11월 까지 오프라인 코딩 부트캠프 위코드에서 프로젝트 경험을 쌓고, <ProfileHighLite>기업에서 프론트엔드 인턴</ProfileHighLite>으로 업무를 했습니다.
<br />
            <br />
            현재는 진행하던 리액트 프로젝트를 이어서 고도화 작업을 진행하고 있습니다.
실력과 경험을 갈고 닦아 <ProfileHighLite>세상의 불편함을 해결해주는 개발자</ProfileHighLite>가 되고싶습니다.
        ...
        <ProjectInfoBox>
          ...
          >
            ...
            />
            <ProjectInsideBox>
              <ProjectTitle>사내 신사업용 의료 종사자 커뮤니티 프로토타입 구축</ProjectTitle>
              <ProjectSkillBox>
        ...
        <ExperienceBox>
          ...
          <ExperienceRight>
            ...
            <br />
            <br />
- 기업의 신사업 기획 (의료 종사자 전용 커뮤니티) 단계에서의 프로토타입 개발.

            <br />
- 기존에 사용하고 있던 리액트 대신에 Next.14를 이용한 MVP 검증

            <br />
- 의료 종사자 커뮤니티 제공을 위해 유사 서비스(링크드인) 구조 분석 및 클론 코딩

            <br />
- 클론 코딩 과정에서 해당 서비스 개발에 필요한 리소스 파악, 문제점 정리, 구현 과정 정리 하여 동료 팀원 및 조직 구성원에게 공유
<br/>
- <HighLight>Next.14를 활용한 MVP에 대해서 긍정적인 반응</HighLight>을 이끌어냄
          </ExperienceRight>
        </ExperienceBox>
        <ExperienceBox>
          <ExperienceLeft>
            <ExperienceTitle>에스케어</ExperienceTitle>
            <ExperiencePic src="./images/에스케어로고.png" alt="에스케어로고" />
          </ExperienceLeft>
          <ExperienceRight>
        ...
        <ExperienceBox>
          ...
          <ExperienceRight>
            ...
            <br />
            개발자 오프라인 부트캠프 위코드에서
            <HighLight>프론트엔드 개발</HighLight> 교육. 1,2,3차
            프로젝트를 통해 백엔드와 통신하는 법을 심도 있게 익혔고, 리액트에
            대한 이해 높임.
            <br />
            <br />
            <BackHighLight>4주간 케어마인드 기업에 인턴으로 참가</BackHighLight>
            하여, 의료인 커뮤니티 구현 프로젝트를 실현. 해당 기업
            협업에서는 Next.js, TypeScript에 대한 이해를 높임.
          </ExperienceRight>
        </ExperienceBox>
        <ExperienceBox>
          <ExperienceLeft>
            <ExperienceTitle>
              패스트 캠퍼스<br/> 데이터 분석가<br/> 과정
            </ExperienceTitle>
            <ExperiencePic src="./images/패스트캠퍼스.png" alt="패스트캠퍼스" />
          </ExperienceLeft>
          <ExperienceRight>
            2022.11 ~ 2023.03
            <br />
            데이터 분석가 역량을 위한 파이썬, 태블러, SQL등을 공부.<br/>
편의점 상권 데이터, 서울 부동산 데이터, 네이버 쇼핑 데이터 를 통해 데이터 분석 역량을 향상 
        ...
        <MyLifeBox>
          ...
          <MyLifeContent>
            ...
            프로젝트에서는 Product Manager를 맡아서 제품의 구성과 완성에 초점을
            맞췄습니다. 3차 프로젝트 때는 프론트엔드 리더로서, 프론트엔드
            팀원들에게 티켓을 적절히 할당하고 수준에 맞는 과제를 주려고
            노력했습니다.
            <br />
            <br />
          ...
          <MyLifeContent>
            ...
            <br />
            <br />
            이 과정 에서 SQL,Python, Excel, Tableau 활용법을 더욱 익히고, 다양한
            분석 프로젝트에 참여하였습니다. 분 석한 프로젝트로는 1. 편의점 상권
            분석 2. 부동산 가격 영향 요인 분석 3. 네이버 모바일 쇼핑광고 크롤링
            키워드 분석 등이 있습니다. 해당 3가지 주제의 팀 프로젝트를 통해
            SQL을 활용한 데이터 추출, Pyth on을 활용한 데이터 분석 Tableau를
            활용한 데이터 시각화로 프로젝트에서 인사이트를 발굴할 수 있었습니다.
            <br />
            <br />
          ...
          <MyLifeContent>
            ...
            <br />
            <br />
            1학년 때는 클래식 기타 동아리 담락재에서 활동하면서 합주 연습을 하며
            다른 사람들과 적극적으로 피드백을 했습니다. 그 결과 연말에
            ...
            위한 따끈따끈 내 몸 좋아 패키지를 떠올렸고 해당 내용 구체화를 위해서
            교수님과 얘기를 나눴습 니다. 교수님을 설득하는 과정에서 군인이었던{" "}
            <BackHighLight>
